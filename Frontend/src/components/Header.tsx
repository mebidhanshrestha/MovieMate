      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <div className="flex items-center gap-10">
            ...
            <div className="hidden md:block">
              <div className="flex items-center space-x-6">
                ...
                <a
                  href="#"
                  className="text-gray-700 whitespace-nowrap hover:text-primary py-2 text-base font-light transition-colors duration-200"
                >
                  Food & Beverages
                </a>
                <a
          ...
          <div className="hidden lg:flex items-center gap-x-12">
            ...
            <Link to="/signup" className="bg-gray-600 whitespace-nowrap text-white px-8 py-2 rounded-[16px] text-sm font-medium hover:bg-gray-700 transition-colors duration-200">
              Sign Up
            </Link>
            </div>
          </div>
      ...
      >
        <div className="px-4 pt-2 pb-3 space-y-1 shadow-lg">
          ...
          <div className="pt-4 space-x-4">
            ...
            <Link to="/signup" className="w-full bg-gray-600 text-white px-4 py-2 rounded-[16px] text-sm font-medium hover:bg-gray-700 transition-colors duration-200">
              Sign Up
            </Link>
          </div>
        </div>
