      ...
      <div className="container mx-auto flex max-lg:flex-wrap lg:flex-row gap-y-10 gap-x-20">
        ...
        <div className="flex flex-col items-start space-y-4 max-w-[360px]">
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            We aim to transform how people experience cinema, from booking to
            snacks.
          </p>
          <p className="text-sm text-gray-500">&copy; {(new Date().getFullYear())} MovieMate Pvt Ltd</p>
        </div>
        ...
        <div className="max-w-[130px]">
          ...
          <ul className="mt-3 space-y-2">
            <li>
              <a href="/movies" className="text-gray-600 hover:text-amber-400 font-roboto">
                Movies
              </a>
            </li>
            <li>
              <a href="#" className="text-gray-600 hover:text-amber-400 font-roboto">
                Theater
              </a>
            </li>
            <li>
            ...
            >
              ...
              >
                <g clip-path="url(#clip0_229_347)">
                  <path
                    d="M21.8719 0.90564H2.13001C1.45381 0.90564 0.90564 1.45381 0.90564 2.13001V21.8719C0.90564 22.5481 1.45381 23.0963 2.13001 23.0963H21.8719C22.5481 23.0963 23.0963 22.5481 23.0963 21.8719V2.13001C23.0963 1.45381 22.5481 0.90564 21.8719 0.90564Z"
                    fill="#3D5A98"
                  />
                  <path
                    d="M16.215 23.0944V14.5013H19.0988L19.53 11.1525H16.215V9.01504C16.215 8.04567 16.485 7.38379 17.8744 7.38379H19.6481V4.38379C18.7892 4.29444 17.9261 4.25188 17.0625 4.25629C14.5088 4.25629 12.75 5.81254 12.75 8.68317V11.1525H9.86627V14.5013H12.75V23.0944H16.215Z"
                    fill="white"
                  />
                </g>
                <defs>
              ...
              >
                <g clip-path="url(#clip0_229_350)">
                  <path
                    ...
                    fill="url(#paint0_radial_229_350)"
                  />
                  <path
                    d="M18.375 0H5.625C2.5184 0 0 2.5184 0 5.625V18.375C0 21.4816 2.5184 24 5.625 24H18.375C21.4816 24 24 21.4816 24 18.375V5.625C24 2.5184 21.4816 0 18.375 0Z"
                    fill="url(#paint1_radial_229_350)"
                  />
                  <path
